...
while True: #відкрила зовнішній цикл передумови щоб програма повторювалась звідси
    ...
    print("Please, choose an action:+, -, *, /") #починаєм обирати математичний оператор
    action = input()
    if action == "+":
        result = num1 + num2
    elif action == "-":
        ...
        print("Invalid operation. Please choose an action:+, -, *, /")
        break #так само як з цифрами, щоб користувач вибрав лише потрібний варіант математичної операції і програма не ламалась
